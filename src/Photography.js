...
const Photography = () => (
  <div>
    ...
    <main className="page" style={{ maxWidth: 1100 }}>
      ...
      <div className="dek">Mostly film, mostly after dark</div>
      <h1 className="page-title">Quiet frames, <em>kept plain.</em></h1>
      <p className="lede">A Leica M6 and a Pentax 67 do most of the work. I develop C-41 at home in a Jobo I restored from a flea market, and I'm stubbornly bad at Portra. Hover any frame for the details.</p>
      ...
      <section className="sec">
        ...
        <div className="photos">
          <Photo caption="Ferry Building, 6am" kit="M6 · Tri-X">
          ...
          <Photo caption="Tunnel no. 3" kit="67 · Portra">
            <svg viewBox="0 0 100 133" preserveAspectRatio="xMidYMid slice">
          ...
          <Photo caption="Alamo Square" kit="M6 · Tri-X">
            <svg viewBox="0 0 100 133" preserveAspectRatio="xMidYMid slice">
          ...
          <Photo caption="Point Reyes" kit="67 · Ektar">
            <svg viewBox="0 0 100 133" preserveAspectRatio="xMidYMid slice">
              <defs>
          ...
          <Photo caption="Kitchen window" kit="M6 · Portra">
            <svg viewBox="0 0 100 133" preserveAspectRatio="xMidYMid slice">
          ...
          <Photo caption="Ocean Beach" kit="M6 · HP5">
          ...
          <Photo caption="Oakland, 11pm" kit="M6 · Delta 3200">
            <svg viewBox="0 0 150 100" preserveAspectRatio="xMidYMid slice">
          ...
          <Photo caption="Marina, dusk" kit="M6 · Tri-X">
            <svg viewBox="0 0 100 133" preserveAspectRatio="xMidYMid slice">
          ...
          <Photo caption="Dolores, Saturday" kit="67 · Portra">
            <svg viewBox="0 0 100 133" preserveAspectRatio="xMidYMid slice">
          ...
          <Photo caption="Doorway, Mission" kit="M6 · Portra">
            <svg viewBox="0 0 100 133" preserveAspectRatio="xMidYMid slice">
      ...
      <section className="sec">
        ...
        <div>
          <ProjectRow yr="2024" title={<span>Night shift, <em>Ocean Beach</em></span>} subtitle="Twelve frames · three midnight walks"
            detail="Shot on Delta 3200, pushed one stop. Printed at 10×10 and kept in a linen folio."
            tag="Series"
          />
          <ProjectRow yr="2023" title={<span>Tokyo, <em>in halves</em></span>} subtitle="A folio of diptychs · two weeks of walking"
            detail="Pentax 67, Portra 400, scanned on an Epson V850. A book is in progress; don't hold your breath."
            tag="Folio"
          />
        </div>
      </section>
      ...
      <section className="sec">
        ...
        <div className="prose">
          <p><em>Leica M6</em> with a 35mm Summicron — the camera I'd grab in a fire. <em>Pentax 67</em> with a 105mm when I want to slow down. A Sekonic L-308X, a handful of Tri-X, and more Portra than I'll finish in a year.</p>
          <p>I develop black-and-white in my bathroom (HC-110, dilution B) and send color to a lab I like in Berkeley. I scan on an Epson V850 and fight with it regularly.</p>
        </div>
      </section>
